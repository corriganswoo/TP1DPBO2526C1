...
### 2. Java
* **Menambahkan Data**
  ![Java Tambah Data](screenshots/java_tambah.png)
  
* **Menampilkan Data**
  ![Java Tampilkan Data](screenshots/java_tampil.png)
* **Mengubah Data**
  ![Java Ubah Data](screenshots/java_update.png)
* **Menghapus Data**
  ![Java Hapus Data](screenshots/java_hapus.png)
* **Mencari Data**
  ![Java Cari Data](screenshots/java_cari.png)
...
* **Menampilkan Data**
  ![Python Tampilkan Data](screenshots/python_tampil.png)
* **Mengubah Data**
  ![Python Ubah Data](screenshots/python_update.png)
* **Menghapus Data**
  ![Python Hapus Data](screenshots/python_hapus.png)
* **Mencari Data**
  ![Python Cari Data](screenshots/python_cari.png)

---

### 4. PHP (Web)
* **Menambahkan Data**
  ![PHP Tambah Data](screenshots/php_tambah.png)
* **Menampilkan Data**
  ![PHP Tampilkan Data](screenshots/php_tampil.png)
* **Mengubah Data**
  ![PHP Ubah Data](screenshots/php_update.png)
* **Menghapus Data**
  ![PHP Hapus Data](screenshots/php_hapus.png)
* **Mencari Data**
  ![PHP Cari Data](screenshots/php_cari.png)
